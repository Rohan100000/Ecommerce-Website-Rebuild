    ...
    <footer className="pt-24 relative">
      ...
      <div className="social absolute top-[41vh] left-[30vw] right-[30vw] w-[40vw] h-[14vh] bg-[#C6B79B]">
        <div id="social-media-icons" className="flex justify-around pt-[3.7vh] px-[3vw]">
          <img src={Twitter} alt="Twitter" className="social-media-images h-[45px] w-[45px] cursor-pointer" />
          <img src={Youtube} alt="YouTube" className="social-media-images h-[45px] w-[45px] cursor-pointer" />
          <img src={LinkedIn} alt="LinkedIn" className="social-media-images h-[45px] w-[45px] cursor-pointer" />
          <img src={Instagram} alt="Instagram" className="social-media-images h-[45px] w-[45px] cursor-pointer" />
        </div>
      </div>
